        ...
        try:
            async with AsyncSessionLocal() as session:
                async with session.begin():
                    ...
                    t_id = t.id
                    t_name = t.name
                    guild_row_org = guild_row.organization_id
                    guild_row_settings = dict(guild_row.settings or {})

            # Create the management channel
            guild_settings: dict = guild_row_settings
            ...
            if manage_ch:
                ...
                cp_view = ControlPanelView(tournament_id=t_id, org_id=guild_row_org)
                ...
                manage_view = TournamentManageView(t_id, guild_row_org)
