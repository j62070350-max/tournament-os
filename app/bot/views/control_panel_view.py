...
class _AddFieldModal(discord.ui.Modal, title="Add Registration Field"):
    ...
    field_type = discord.ui.TextInput(
        label="Type: short_text / long_text / number",
    ...
    async def on_submit(self, interaction: discord.Interaction) -> None:
        ...
        raw_type = self.field_type.value.strip().lower() or "short_text"
        type_map = {
            "text": "short_text", "short": "short_text", "short_text": "short_text",
            "long_text": "long_text", "paragraph": "long_text", "long": "long_text",
            "number": "number", "numeric": "number", "int": "number",
        }
        resolved_type = type_map.get(raw_type, "short_text")
