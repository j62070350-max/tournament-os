    ...
    async def on_submit(self, interaction: discord.Interaction) -> None:
        ...
        try:
            ...
            if d_guild and guild_settings:
                ...
                # We create the tournament category for match rooms and private data,
                # but we NO LONGER create general info channels (announcements, rules, etc.)
                # as those are handled by the global infrastructure from /setup tournament.
